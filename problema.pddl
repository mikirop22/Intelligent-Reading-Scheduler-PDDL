(define (problem PlanLectura_Problema)
    ...
    (:init
        ...
        ;(paralelos StarWars1 StarWarsJedi)
        (paralelos StarWarsDark StarWars1)
        (paralelos Harry1 StarWars1)
        (paralelos Harry1 StarWarsDark)
        ...
        (=(paginas_libro Vengadores)200)
        (=(paginas_libro CapitanAmerica)200)
        (=(paginas_libro IronMan)200)
    )
